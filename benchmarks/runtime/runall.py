...
Run time benchmarks.
    ...
    python benchmarks/runtime/runall.py module
...
Process
-------
files = [filename for filename in 'benchmarks/runtime/' if 'bench' in filename]
benchmarks = [class for class in filenames if 'runtime' in class_name]
...
from benchmarks.runtime import modules
